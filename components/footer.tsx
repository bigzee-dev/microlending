        ...
        <div className="grid gap-12 lg:grid-cols-12">
          <div className="lg:col-span-5">
            ...
            <div className="mt-7 flex gap-3">
              ...
              <SocialIcon
                label="Facebook"
                href="https://facebook.com/microlendingbw"
                colour="#1877F2"
              >
                <svg
                  viewBox="0 0 24 24"
              ...
              <SocialIcon
                label="Email"
                href="mailto:hello@microlending.co.bw"
                colour="#B85530"
              >
                <svg
                  viewBox="0 0 24 24"
        ...
        <div className="mt-16 border-t border-ink-200 pt-8 dark:border-ink-800">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <p className="font-mono text-[11px] uppercase tracking-widest text-ink-500 dark:text-ink-300">
              © {new Date().getFullYear()} MicroLending (Pty) Ltd · Reg.
              2024/XXXXX/07
            </p>
...
function SocialIcon({
  ...
  return (
    ...
    >
      <span className="absolute inset-0 -z-10 scale-0 rounded-full transition-transform duration-500 group-hover:scale-100 group-hover:bg-[var(--c)]" />
