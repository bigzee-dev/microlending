const steps = [
  {
    ...
    title: "Apply online",
    body:
      "Fill in a short form using your Omang and proof of income. Takes about five minutes — entirely from your phone.",
    duration: "≈ 5 min",
  },
  {
    n: "II",
    ...
    body:
      "Our system runs an affordability check on the spot. If you qualify, you'll see your offer and repayment date straight away.",
    duration: "≈ 30 sec",
  },
  {
    n: "III",
    ...
    body:
      "Once approved, your money lands in your Botswana bank account — usually within an hour, on business days.",
    duration: "≈ 60 min",
  },
  {
    n: "IV",
    ...
    body:
      "We remind you by SMS before the due date. Repay in one lump sum and you're free to borrow again whenever.",
    duration: "as agreed",
  },
];
          ...
          {steps.map((s, idx) => (
            ...
            >
              <div className="flex items-baseline justify-between">
                <span className="font-display text-7xl font-medium leading-none tracking-editorial text-clay-500/70 transition group-hover:text-clay-600 dark:text-clay-300/60 dark:group-hover:text-clay-300">
                  {s.n}
                </span>
