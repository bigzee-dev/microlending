export function Testimonials() {
  return (
    <section className="relative border-y border-ink-800/70 bg-ink-950 py-24 sm:py-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-10">
        <div className="grid items-end gap-8 lg:grid-cols-12">
          ...
          <div className="lg:col-span-4 lg:text-right">
            <div className="flex items-baseline justify-end gap-2 text-clay-300">
              {[0, 1, 2, 3, 4].map((i) => (
            ...
            <p className="mt-3 font-display text-3xl font-medium tracking-editorial text-cream-100">
        ...
        <div className="mt-16 border border-ink-800">
          <figure className="group relative flex flex-col bg-ink-900 p-8 transition sm:p-10 lg:p-14">
            <span className="font-display text-8xl italic leading-none text-clay-300 sm:text-9xl">
              &ldquo;
            </span>
            ...
            <figcaption className="mt-8 flex items-center gap-4 border-t border-ink-800 pt-6">
              ...
              <div className="leading-tight">
                <div className="font-display text-base font-medium text-cream-100 sm:text-lg">
                  Kgomotso D.
                </div>
